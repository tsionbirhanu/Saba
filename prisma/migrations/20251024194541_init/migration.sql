-- CreateEnum
CREATE TYPE "Role" AS ENUM ('BUYER', 'DESIGNER');
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_designerProfileId_fkey" FOREIGN KEY ("designerProfileId") REFERENCES "DesignerProfile"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
